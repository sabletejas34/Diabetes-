...
SkinThickness = st.number_input("SkinThickness", min_value=0, max_value=100.0, value=15.0 , step=0.5)
Insulin = st.number_input("Insulin", min_value=0, max_value=1000, value=79, step=0.5)
BMI = st.number_input("BMI", min_value=0.0, max_value=100.0, value=31.25, step=0.5)
DiabetesPedigreeFunction = st.number_input("DiabetesPedigreeFunction",min_value=0.0, max_value=5, value=1.0 , step=0.1)
